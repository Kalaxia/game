...
class TechnologyResource
{
	...
	// UNBLOCK technologies
		...
		[
			...
			'points' => 4,
			'column' => 2,
			'shortDescription' => 'Débloque le chasseur léger.',
			'description' => 'Le châssis léger simple est une technologie qui vous permet de développer et de produire vos tous premiers vaisseaux, les chasseurs légers.',
		],
		[
			...
			'points' => 6,
			'column' => 2,
			'shortDescription' => 'Débloque le chasseur.',
			'description' => 'En modifiant quelque peu le châssis léger simple et en transformant la carcasse d’un chasseur léger, vos chercheurs peuvent développer un nouveau type de chasseur, le chasseur.',
		],
		[
		...
		[
			...
			'points' => 10,
			'column' => 2,
			'shortDescription' => 'Débloque la corvette légère.',
			'description' => 'Le châssis nodal, permettant la construction de la corvette légère, améliore et renforce considérablement la puissance de défense des vaisseaux.',
		],
		[
		...
		[
			...
			'points' => 20,
			'column' => 3,
			'shortDescription' => 'Débloque le destroyer.',
			'description' => 'Le châssis polymère, développé pour la construction de destroyer, vous donnera la possibilité de construire un destroyer. Ce châssis est trois fois plus grand que le châssis modulaire, mais également beaucoup plus solide.',
		],
		[
			...
			'points' => 26,
			'column' => 3,
			'shortDescription' => 'Débloque le destroyer lance-missiles.',
			'description' => 'Le châssis polymère renforcé a été développé pour améliorer la stabilité du destroyer lance-missiles, dans le but de lui permettre de lancer de plus gros missiles tout en gardant une bonne précision.',
		],
		[
			...
			'points' => 32,
			'column' => 3,
			'shortDescription' => 'Débloque le croiseur.',
			'description' => 'En modifiant quelque peu le châssis polymère renforcé, une de vos équipes de chercheurs a développé un nouveau type de vaisseau – le croiseur.',
		],
		[
			...
			'points' => 40,
			'column' => 3,
			'shortDescription' => 'Débloque le croiseur lourd.',
			'description' => 'Cette amélioration du châssis polymère amélioré vous permet de construire le vaisseau le plus puissant de la galaxie de l’œil – Le croiseur lourd. En renforçant et en améliorant l’ergonomie de ce châssis, vos chercheurs ont pu stabiliser et augmenter la puissance de feu du vaisseau.',
		],
		[
			'name' => 'Colonisation',
	...
	// LEVEL technologies
		...
		[
			...
			'description' => 'La technologie du calibre 5 améliore directement l’armement de vos chasseurs. Vos chasseurs légers et vos chasseurs auront, de ce fait, une plus grande puissance de feu face à vos ennemis.',
			'bonus' => 3,
		],
		[
